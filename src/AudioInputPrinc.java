...
class AudioInputPrinc{
	...
	public static void main(String[] args){
		...
		AudioInputPrinc ai = new AudioInputPrinc();
		...
		long startTime = System.currentTimeMillis();
			...
			ai.findFrequency();
			// ai.printFrequency();
		System.out.println("Time taken : "+((System.currentTimeMillis()-startTime)/1000.00) +" ms");
	}
